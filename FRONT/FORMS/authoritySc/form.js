/* SCSLAI — SC Authority to Deduct Form (FORM NO. 0427)
...
signYear:"Year today",signPlace:"Place Signed",signatureOverName:"Signature Over Printed Name",
...
pdfPrefix:"SC-Authority-To-Deduct-",
pdfSuffix:"Form",
images:["FORMS/AUTHORITY TO DEDUCT - form - SC.png"],
...
return{form:"authoritySc",fields:vals,civilStatus:cs.length?cs[0].label:""};
}
